function [g_dict,h_dict] = cals10_get_gh_at_t(time)
...
load cals10_coeffs.mat
load cals10_knots.mat

lmax=10;

if time<cals_knots(3)|time>cals_knots(end-3)
   %warning('Time is not in the time range!') 
   error('The time you chosen is outside this model')
end
    

sp1 = spmak(cals_knots,cals_coeffs');  
