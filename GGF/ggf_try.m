...
t=1000;  %year 。（ -98050 to 1990  )


ge=14;

rm=6371*ones(1,ge);   %calculate B at CMB in KM
...
title('R=3480 km Meridional Slice of Br,  10deg W, Time=1000 year')
...
print('-dtiff ','-r600',[ '/Users/gaojiawei/Desktop/','ggf1_cmb1.tiff'])
