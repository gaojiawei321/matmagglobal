function [bpcsph] = ARH_r(pc_xyz,time)
%ARH_r Summary of this function goes here
%ARH_r model to calculate magnetic field of arhimag1k model
%Combining archeomagnetic, volcanic and historical data

% get the Gaussian coefficient

    
[g,h] =ARH_get_gh_at_t(time);
